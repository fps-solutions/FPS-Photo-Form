...
export const panelVersionNumber = '2026-06-06 - 0.0.19 PF'; //Added to show in panel
...
export function aboutTable( bannerProps: IWebpartBannerProps ): { table: IHelpTable } {
    ...
    table.rows.push( createAboutRow('2026-06-07',"0.0.19",`#130, #131, #132, #133, #134, #135, #136 - Mouse Drag chart`, bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('2026-06-07',"0.0.18",`#119, #`, bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
