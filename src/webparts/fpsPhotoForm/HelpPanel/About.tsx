...
export const panelVersionNumber = '2024-10-22 - 0.0.4 PF'; //Added to show in panel
...
export function aboutTable( bannerProps: IWebpartBannerProps ): { table: IHelpTable } {
    ...
    table.rows.push( createAboutRow('2024-10-20',"0.0.4","#20, #22, #28, #29, #31, #32, #33, #34, #36", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
    table.rows.push( createAboutRow('V',"V","#14, #17, #24, #25, #26", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
