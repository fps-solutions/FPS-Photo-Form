...
export const panelVersionNumber = '2024-11-01 - 0.0.8 PF'; //Added to show in panel
...
export function aboutTable( bannerProps: IWebpartBannerProps ): { table: IHelpTable } {
    ...
    table.rows.push( createAboutRow('2024-11-01',"0.0.8",`#64, #65`, bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
