...
export type IMIMEType_Specific = IMIMEType_Image | IMIMEType_PDF | IMIMEType_Word | IMIMEType_Excel | IMIMEType_PPT | IMIMEType_Text | IMIMEType_RichText | IMIMEType_Open | IMIMEType_Compressed | IMIMEType_Video;
export type IMIMEType_Valid = IMIMEType_Specific | IMIMEType_ANY;

export type IMIMETypeType = 'Image' | 'Office' | 'Video' | 'Text' | 'Compressed' | 'Other' | 'All';
...
export const Common_MIME_TYPES: IMIMEType_Specific[] = [
  ...MIMETypes_ImageCommon.types,
  ...MIMETypes_PDF.types,
  ...MIMETypes_MSFTWord.types,
  ...MIMETypes_MSFTExcel.types,
  ...MIMETypes_MSFTPPT.types,
  ...MIMETypes_Text.types,
  ...MIMETypes_RichTextCommon.types,
  ...MIMETypes_Open.types,
  ...MIMETypes_Compressed.types,
  ...MIMETypes_VideoCommon.types,
];

// Define an object for accepted MIME types
export const Other_MIME_TYPES: IMIMEType_Specific[] = [
  ...MIMETypes_ImageBrowser.types,
  ...MIMETypes_RichTextRare.types,
  ...MIMETypes_VideoRare.types,
];

// Define an object for accepted MIME types
export const Specific_MIME_TYPES: IMIMEType_Specific[] = [
  ...MIMETypes_ImageCommon.types,
  ...MIMETypes_ImageBrowser.types,
  ...MIMETypes_PDF.types,
  ...MIMETypes_MSFTWord.types,
